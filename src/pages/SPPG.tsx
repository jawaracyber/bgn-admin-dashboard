  ...
  return (
    <div className="space-y-4 sm:space-y-6 md:space-y-8 p-3 sm:p-4 md:p-6 lg:p-8">
      <motion.div
        ...
        className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4"
      >
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent mb-1.5 sm:mb-2 md:mb-3">
            Data SPPG
          </h1>
